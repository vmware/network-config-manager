...
_public_ int ncm_create_bridge(int argc, char *argv[]) {
       ...
       for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "dev") || str_equal_fold(argv[i], "device") || str_equal_fold(argv[i], "link")) {
                ...
                } else if (str_equal_fold(argv[i], "stp")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        b->stp = r;
                        continue;
                } else if (str_equal_fold(argv[i], "vlan-protocol")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        b->vlan_protocol = r;
                        continue;
                } else if (str_equal_fold(argv[i], "vlan-filtering")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        b->vlan_filtering = r;
                        continue;
                } else if (str_equal_fold(argv[i], "mcast-snooping")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        b->mcast_snooping = r;
                        continue;
                } else if (str_equal_fold(argv[i], "mcast-querier")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_bond(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "mode") || str_equal_fold(argv[i], "m")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        b->mode = r;
                } if (str_equal_fold(argv[i], "xmit-hash-policy") || str_equal_fold(argv[i], "xhp")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "dev") || str_equal_fold(argv[i], "device") || str_equal_fold(argv[i], "link")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_macvlan(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "dev") || str_equal_fold(argv[i], "device") || str_equal_fold(argv[i], "link")) {
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "mode")) {
                        parse_next_arg(argv, argc, i);
        ...
        if (str_equal_fold(argv[0], "create-macvlan"))
...
_public_ int ncm_create_ipvlan(int argc, char *argv[]) {
        ...
        if (str_equal_fold(argv[0], "create-ipvlan"))
...
_public_ int ncm_create_vxlan(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "dev") || str_equal_fold(argv[i], "device") || str_equal_fold(argv[i], "link")) {
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "vni")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        have_vni = true;
                        continue;
                } else if (str_equal_fold(argv[i], "local")) {
                       _auto_cleanup_ IPAddress *ip = NULL;
                        ...
                        v->local = *ip;
                        continue;
                } else if (str_equal_fold(argv[i], "remote")) {
                       _auto_cleanup_ IPAddress *ip = NULL;
                       ...
                       parse_next_arg(argv, argc, i);
                        ...
                        v->group = *ip;
                        continue;
                } else if (str_equal_fold(argv[i], "independent")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_vlan(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "dev") || str_equal_fold(argv[i], "device") || str_equal_fold(argv[i], "link")) {
                        ...
                        have_id = true;
                        continue;
                } else if (str_equal_fold(argv[i], "proto") || str_equal_fold(argv[i], "protocol")) {
                        parse_next_arg(argv, argc, i);

                        if (str_equal_fold(argv[i], "802.1q") || str_equal_fold(argv[i], "802.1ad")) {
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "gvrp")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "mvrp")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "loose-binding")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "reorder-hdr")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_vrf(int argc, char *argv[]) {
        ...
        for (int i = 1; i < argc; i++) {
                if (str_equal_fold(argv[i], "table") || str_equal_fold(argv[i], "t")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_wireguard_tunnel(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "private-key")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "private-key-file")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "public-key")) {
                        parse_next_arg(argv, argc, i);
                ...
                } else if (str_equal_fold(argv[i], "preshared-key")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "preshared-key-file")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        if (!peer->preshared_key_file)
                                return log_oom();
                        continue;
                } else if (str_equal_fold(argv[i], "allowed-ips")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "endpoint")) {
                        _auto_cleanup_ IPAddress *address = NULL;
                        uint16_t port;
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "listen-port")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_create_tun_tap(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "user") || str_equal_fold(argv[i], "usr")) {
                        struct passwd *pw;
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "group") || str_equal_fold(argv[i], "grp")) {
                        struct group *g;
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (str_equal_fold(argv[i], "mq")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        t->multi_queue = r;
                        continue;
                } else if (str_equal_fold(argv[i], "pkt-info")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        t->packet_info = r;
                        continue;
                } else if (str_equal_fold(argv[i], "kc")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        t->keep_carrier = r;
                        continue;
              } else if (str_equal_fold(argv[i], "vnet-hdr")) {
                        parse_next_arg(argv, argc, i);
        ...
        r = manager_create_tun_tap(argv[1], str_equal(argv[0], "create-tun") ? NETDEV_KIND_TUN: NETDEV_KIND_TAP, t);
        if (r < 0) {
...
_public_ int ncm_remove_netdev(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (str_equal_fold(argv[i], "kind") || str_equal_fold(argv[i], "k")) {
                        parse_next_arg(argv, argc, i);
