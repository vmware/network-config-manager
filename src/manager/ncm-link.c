...
_public_ int ncm_configure_link(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "alias")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "desc")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "duplex")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "wolp")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "port")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "advertise")) {
                        parse_next_arg(argv, argc, i);
        ...
        r = netdev_link_configure(p->ifname, n);
        if (r < 0) {
...
_public_ int ncm_configure_link_features(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "auton")) {
                        ...
                        n->auto_nego = r;
                        continue;
                } else if (streq_fold(argv[i], "rxcsumo")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->rx_csum_off = r;
                        continue;
                } else if (streq_fold(argv[i], "txcsumo")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->tcp_seg_off = r;
                        continue;
                } else if (streq_fold(argv[i], "tso6")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->gen_seg_off = r;
                        continue;
                } else if (streq_fold(argv[i], "grxo")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->gen_rx_off = r;
                        continue;
                } else if (streq_fold(argv[i], "grxoh")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->gen_rx_off_hw = r;
                        continue;
                } else if (streq_fold(argv[i], "lrxo")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->large_rx_off = r;
                        continue;
                } else if (streq_fold(argv[i], "rxvtha")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txvtha")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxvtf")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txvstha")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->n_tpl_fltr = r;
                        continue;
                } else if (streq_fold(argv[i], "uarxc")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "uatxc")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_buf_size(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "rxbuf")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxminbuf")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxjumbobuf")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txbuf")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_queue_size(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                ...
                if (streq_fold(argv[i], "txq")) {
                        ...
                        n->rx_queues = v;
                        continue;
                } else if (streq_fold(argv[i], "txqlen")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_flow_control(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "rxflowctrl")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->rx_flow_ctrl = r;
                        continue;
                } else if (streq_fold(argv[i], "txflowctrl")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        n->tx_flow_ctrl = r;
                        continue;
                } else if (streq_fold(argv[i], "autoflowctrl")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_gso(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "gsob")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "gsos")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_channel(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "rxch")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txch")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "otrch")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "combch")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_coalesce(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "rxcs")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxcsirq")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxcslow")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxcshigh")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txcs")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txcsirq")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txcslow")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txcshigh")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_coald_frames(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "rxmcf")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxmcfirq")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxmcflow")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "rxmcfhigh")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txmcf")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txmcfirq")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txmcflow")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "txmcfhigh")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_coal_pkt(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "cprlow")) {
                        ...
                        continue;
                } else if (streq_fold(argv[i], "cprhigh")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "cprsis")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "sbcs")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_altname(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "altnamepolicy")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "altname")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_name(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "namepolicy")) {
                        parse_next_arg(argv, argc, i);
...
_public_ int ncm_configure_link_mac(int argc, char *argv[]) {
        ...
        for (int i = 2; i < argc; i++) {
                if (streq_fold(argv[i], "macpolicy")) {
                        parse_next_arg(argv, argc, i);
                        ...
                        continue;
                } else if (streq_fold(argv[i], "macaddr") || streq_fold(argv[i], "mac")) {
                        parse_next_arg(argv, argc, i);
