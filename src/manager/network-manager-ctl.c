...
static int cli_run(int argc, char *argv[]) {
        ...
        static const Ctl commands[] = {
                ...
                { "set-link-state",                "link-state",       4,        WORD_ANY, false, ncm_link_update_state },
                { "add-addr",                      "add-a",            4,        WORD_ANY, false, ncm_link_add_address },
                { "show-addr",                     "a",                4,        WORD_ANY, false, ncm_display_one_link_addresses },
                { "del-addr",                      "del-a",            4,        WORD_ANY, false, ncm_link_delete_address },
                { "add-default-gw",                "gw",               4,        WORD_ANY, false, ncm_link_add_default_gateway },
                { "delete-gw",                     "dgw",              4,        WORD_ANY, false, ncm_link_delete_gateway_or_route },
                ...
                { "set-ipv6mtu",                   "ipv6mtu",          3,        WORD_ANY, false, ncm_link_set_network_ipv6_mtu },
                ...
                { "disable-ipv6",                  "dipv6",            2,        WORD_ANY, false, ncm_link_enable_ipv6 },
                { "enable-ipv6",                   "eipv6",            2,        WORD_ANY, false, ncm_link_enable_ipv6 },
