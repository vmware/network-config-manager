...
static int help(void) {
        printf("%s [OPTIONS...]\n\n"
               ...
               "  set-ipv4                     dev [DEVICE] addr [ADDRESS] many [ADDRESS1,ADDRESS2...] gw|gw4|g [GATEWAY] dhcp [BOOLEAN] keep [BOOLEAN] Configures device IPv4.\n"
               "  set-ipv6                     dev [DEVICE] accept-ra [BOOLEAN] dhcp [BOOLEAN] keep [BOOLEAN] address|a|addr [ADDRESS] many [ADDRESS1,ADDRESS2...] gw|gw6|g [GATEWAY] Configures device IPv6.\n"
