...
static int help(void) {
        printf("%s [OPTIONS...]\n\n"
               ...
               "  set-llmnr                    [LINK] [LLMNR {yes | no | on | off | 1 | 0}] Set Link Local Multicast Name Resolution\n"
               ...
               "  add-ipv6-ra                  [LINK] prefix [Prefix ADDRESS] pref-lifetime [PreferredLifetimeSec NUMBER] valid-lifetime [ValidLifetimeSec NUMBER]"
...
static int cli_run(int argc, char *argv[]) {
        ...
        static const Cli commands[] = {
                ...
                { "add-ipv6-ra",                  1,        WORD_ANY, false, ncm_link_add_ipv6_router_advertisement },
