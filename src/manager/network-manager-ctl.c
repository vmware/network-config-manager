...
static int help(void) {
        printf("%s [OPTIONS...]\n\n"
               ...
               "  create-bridge                [BRIDGE name] [stp BOOLEAN] [vlan-protocol BOOLEAN] [vlan-filtering BOOLEAN] [mcast-snooping BOOLEAN] [mcast-querier BOOLEAN] dev [DEVICE,DEVICE ...] Creates bridge netdev and sets master to device\n"
