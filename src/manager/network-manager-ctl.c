...
static int help(void) {
        printf("%s [OPTIONS...]\n\n"
               ...
               "  create-vrf                   [VRF name] table [INTEGER}]\n"
               ...
               "  create-sit                   [dev LINK] [SIT name] [local ADDRESS] [remote ADDRESS] [independent { yes | no | on | off | 1 | 0}] Creates sit tunnel\n"
               "  create-vti                   [dev LINK] [VTI name] [local ADDRESS] [remote ADDRESS] [independent { yes | no | on | off | 1 | 0}] Creates vti tunnel\n"
               "  create-gre                   [dev LINK] [GRE name] [local ADDRESS] [remote ADDRESS] [independent { yes | no | on | off | 1 | 0}] Creates gre tunnel\n"
