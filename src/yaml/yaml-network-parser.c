...
static ParserTable parser_network_vtable[] = {
        ...
        { "dhcp6-use-domain",       CONF_TYPE_NETWORK,     parse_yaml_bool,                   offsetof(Network, dhcp6_use_domains)},
        { "dhcp6-use-mtu",          CONF_TYPE_NETWORK,     parse_yaml_bool,                   offsetof(Network, dhcp6_use_mtu)},
