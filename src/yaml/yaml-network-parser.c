...
static ParserTable parser_network_vtable[] = {
        ...
        { "dhcp-client-identifier", CONF_TYPE_NETWORK,     parse_yaml_dhcp_client_identifier, offsetof(Network, dhcp_client_identifier_type)},
        { "use-dns",                CONF_TYPE_NETWORK,     parse_yaml_bool,                   offsetof(Network, use_dns)},
        { "use-domain",             CONF_TYPE_NETWORK,     parse_yaml_bool,                   offsetof(Network, use_domains)},
        { "use-mtu",                CONF_TYPE_NETWORK,     parse_yaml_bool,                   offsetof(Network, use_mtu)},
