...
class TestNetworkConfigManagerYAML:
    ...
    def test_match_driver(self):
        self.copy_yaml_file_to_netmanager_yaml_path('match-driver.yaml')
    ...
    def test_network_link(self):
        self.copy_yaml_file_to_netmanager_yaml_path('network-link.yaml')
    ...
    def test_network_network(self):
        self.copy_yaml_file_to_netmanager_yaml_path('network-network.yaml')
    ...
    def test_dhcp4_static_dns(self):
        self.copy_yaml_file_to_netmanager_yaml_path('dhcp-static-dns.yaml')
    ...
    def test_dhcp4_dhcp6_static_dns(self):
        ...
        assert(parser.get('DHCPv4', 'RapidCommit') == 'yes')
    ...
    def test_network_gw_onlink(self):
        self.copy_yaml_file_to_netmanager_yaml_path('gw-onlink.yaml')
    ...
    def test_network_static_gw(self):
        self.copy_yaml_file_to_netmanager_yaml_path('static-gw.yaml')
        ...
        assert(parser.get('Route', 'FastOpenNoCookie') == 'yes')
        assert(parser.get('Route', 'TTLPropagate') == 'yes')
    ...
    def test_network_ipv6(self):
        self.copy_yaml_file_to_netmanager_yaml_path('ipv6-config.yaml')
...
class TestNetDevConfigManagerYAML:
    ...
    def test_netdev_bridge(self):
        self.copy_yaml_file_to_netmanager_yaml_path('bridge.yaml')
        ...
        subprocess.call("nmctl remove-netdev br0 kind bridge", shell = True)

    def test_netdev_tunnel(self):
        self.copy_yaml_file_to_netmanager_yaml_path('tunnel.yaml')
    ...
    def test_netdev_tunnel_keys(self):
        self.copy_yaml_file_to_netmanager_yaml_path('tunnel-keys.yaml')
    ...
    def test_netdev_vrf(self):
        ...
        subprocess.call("nmctl remove-netdev vrf1005 kind vrf", shell = True)

    def test_netdev_vxlan(self):
        self.copy_yaml_file_to_netmanager_yaml_path('vxlan.yaml')
        ...
        subprocess.call("nmctl remove-netdev vxlan1 kind vxlan", shell = True)

    def test_netdev_wireguard(self):
        self.copy_yaml_file_to_netmanager_yaml_path('wireguard.yaml')
        ...
        subprocess.call("nmctl remove-netdev home0", shell = True)

    def test_netdev_wireguard_multiple_peer(self):
        self.copy_yaml_file_to_netmanager_yaml_path('wg-multiple.yaml')
        ...
        subprocess.call("nmctl remove-netdev wg0", shell = True)
        subprocess.call("nmctl remove-netdev wg1", shell = True)
...
class TestCLINetwork:
    ...
    def test_cli_link_status_with_logs(self):
        subprocess.check_call("nmctl status 2 -l", text=True, shell = True)
    ...
    def test_cli_set_dns_keep(self):
        assert(link_exist('test99') == True)
    ...
    def test_cli_revert_dns_or_domain(self):
        ...
        subprocess.check_call("nmctl set-dhcp dev test99 dhcp yes", shell = True)
        subprocess.check_call("sleep 5", shell = True)
        subprocess.check_call("nmctl set-dns dev test99 dns 192.168.1.46,192.168.1.45", shell = True)
    ...
    def test_cli_dns_mode_dhcp(self):
        assert(link_exist('test99') == True)
        ...
        assert(json_object["DNSMode"] == "DHCP")

    def test_cli_dns_mode_static(self):
        assert(link_exist('test99') == True)
    ...
    def test_cli_set_dhcp4_iaid(self):
        ...
        subprocess.check_call("nmctl set-dhcp-iaid dev test99 f 4 iaid 0xb6220feb", shell = True)
    ...
    def test_cli_set_dhcp6_iaid(self):
        ...
        subprocess.check_call("nmctl set-dhcp-iaid dev test99 f 6 iaid 0xb6220feb", shell = True)
    ...
    def test_cli_set_ipv6(self):
        ...
        subprocess.check_call("nmctl set-ipv6 dev test99 accept-ra no dhcp yes", shell = True)
...
class TestCLINetDev:
    ...
    def test_cli_create_vlan(self):
        ...
        subprocess.call("nmctl remove-netdev vlan-98 kind vlan" , shell = True)
    ...
    def test_cli_create_macvlan(self):
        ...
        subprocess.call("nmctl remove-netdev macvlan-98 kind macvlan" , shell = True)
    ...
    def test_cli_create_macvtap(self):
        ...
        subprocess.call("nmctl remove-netdev macvtap-98 kind macvtap" , shell = True)
    ...
    def test_cli_create_ipvlan(self):
        ...
        subprocess.call("nmctl remove-netdev ipvlan-98 kind ipvlan" , shell = True)
    ...
    def test_cli_create_ipvtap(self):
        ...
        subprocess.call("nmctl remove-netdev ipvtap-98 kind ipvtap" , shell = True)
    ...
    def test_cli_create_vrf(self):
        ...
        subprocess.call("nmctl remove-netdev vrf-98 kind vrf" , shell = True)
    ...
    def test_cli_create_veth(self):
        ...
        subprocess.call("nmctl remove-netdev veth-98 kind veth" , shell = True)
    ...
    def test_cli_create_tap_no_args(self):
        ...
        subprocess.call("nmctl remove-netdev test-tap kind tap" , shell = True)
    ...
    def test_cli_create_tun(self):
        ...
        subprocess.call("nmctl remove-netdev test-tun kind tun" , shell = True)
    ...
    def test_cli_create_ipip_without_master_device(self):
        ...
        subprocess.call("nmctl remove-netdev ipip-98 kind ipip" , shell = True)
    ...
    def test_cli_create_gre(self):
        ...
        subprocess.call("nmctl remove-netdev gre-98 kind gre" , shell = True)
    ...
    def test_cli_create_vti(self):
        ...
        subprocess.call("nmctl remove-netdev vti-98 kind vti" , shell = True)
