...
static void test_add_remove_many_address(void **state) {
        ...
        assert_true(system("nmctl remove-addr dev test99 many 192.168.1.5/24,192.168.1.6/24,192.168.1.7/24,192.168.1.8/24") >= 0);
...
static void test_cli_set_ipv6_with_static_address(void **state) {
        ...
        assert_true(system("nmctl set-ipv6 dev test99 accept-ra no dhcp no many fe80::10/64,fe80::11/64,fe80::12/64,fe80::13/64,fe80::14/64 gw fe80::1") >= 0);
...
static void test_cli_set_ipv6_with_send_release(void **state) {
        ...
        assert_true(system("nmctl set-ipv6 dev test99 dhcp yes send-release no") >= 0);
...
static void test_cli_set_ipv6_with_static_address_and_dns(void **state) {
        ...
        assert_true(system("nmctl set-ipv6 dev test99 dhcp no use-dns no addr fe80::10 gw fe80::1 dns fe80::4,fe80::5") >= 0);
...
static void test_add_one_address(void **state) {
...
static void test_add_remove_address(void **state) {
        ...
        assert_true(key_file_config_exists(key_file1, "Address", "Address", "192.168.1.5/24"));

        assert_true(system("nmctl remove-addr dev test99 a 192.168.1.5/24") >= 0);
...
static void test_add_remove_many_address_family(void **state) {
        ...
        assert_true(system("nmctl add-addr dev test99 many fe80::10/64,fe80::11/64,fe80::12/64,fe80::13/64,fe80::14/64,192.168.1.5/24,192.168.1.6/24,192.168.1.7/24,192.168.1.8/24") >= 0);
        assert_true(system("nmctl remove-addr dev test99 family yes") >= 0);
...
static void test_replace_many_address_ipv6(void **state) {
        ...
        assert_true(system("nmctl add-addr dev test99 many fe80::10/64,fe80::11/64,fe80::12/64,fe80::13/64,fe80::14/64,192.168.1.5/24,192.168.1.6/24") >= 0);
        ...
        assert_true(system("nmctl replace-addr dev test99 many fe80::17/64,fe80::18/64 family ipv6") >= 0);
        ...
        assert_true(key_file_config_exists(key_file, "Address", "Address", "fe80::17/64"));
        assert_true(key_file_config_exists(key_file, "Address", "Address", "fe80::18/64"));
        assert_true(key_file_config_exists(key_file, "Address", "Address", "192.168.1.5/24"));
        assert_true(key_file_config_exists(key_file, "Address", "Address", "192.168.1.6/24"));

        assert_false(key_file_config_exists(key_file, "Address", "Address", "fe80::10/64"));
        assert_false(key_file_config_exists(key_file, "Address", "Address", "fe80::11/64"));
...
static void test_replace_many_address_ipv4(void **state) {
        ...
        assert_true(system("nmctl replace-addr dev test99 many 192.168.1.7/24,192.168.1.8/24 family ipv4") >= 0);
...
int main(void) {
        ...
        cmocka_unit_test (test_add_remove_many_address),
        ...
        cmocka_unit_test (test_add_remove_many_address_family),
        cmocka_unit_test (test_replace_many_address_ipv6),
        cmocka_unit_test (test_replace_many_address_ipv4),
        ...
        cmocka_unit_test (test_set_ipv4_dhcp_yes_with_static_address_static_dns),
        cmocka_unit_test (test_set_ipv4_dhcp_yes_with_static_address_static_dns_use_dns_no),
        cmocka_unit_test (test_set_ipv6_dhcp_yes_accept_ra_yes),
        cmocka_unit_test (test_set_ipv6_dhcp_no_accept_ra_yes),
        cmocka_unit_test (test_set_ipv4_dhcp_yes_with_static_remove_static_automatic),
        cmocka_unit_test (test_set_ipv6_dhcp_yes_with_static_remove_static_automatic),
        cmocka_unit_test (test_set_ipv6_dhcp_no_with_static_remove_static_automatic),
        ...
        cmocka_unit_test (test_vami_set_network_dhcp4_autov6),
        cmocka_unit_test (test_vami_set_network_static_ipv4_autov6),
        /* vami test cases with set-dynamic and set-static */
        cmocka_unit_test (test_vami_set_dynamic_autov6),
        cmocka_unit_test (test_vami_set_dynamic_dhcpv4),
        cmocka_unit_test (test_vami_set_dynamic_dhcpv6),
        cmocka_unit_test (test_vami_set_dynamic_dhcpv4_and_dhcpv6),
